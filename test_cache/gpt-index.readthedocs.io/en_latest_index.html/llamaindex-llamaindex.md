...
*   [ ] 
    ...
    *   [ ]  Agents
        ...
        *   [Agentic rag with llamaindex and vertexai managed index](https://docs.llamaindex.ai/en/latest/examples/agent/agentic_rag_with_llamaindex_and_vertexai_managed_index/)
        ...
        *   [Structured Planning Agent](https://docs.llamaindex.ai/en/latest/examples/agent/structured_planner/)
    ...
    *   [ ]  Cookbooks
        ...
        *   [Metadata Extraction](https://docs.llamaindex.ai/en/latest/examples/cookbooks/oreilly_course_cookbooks/Module-4/Metadata_Extraction/)
    ...
    *   [ ]  Data Connectors
        ...
        *   [MilvusReader](https://docs.llamaindex.ai/en/latest/examples/data_connectors/MilvusReaderDemo/)
    ...
    *   [ ]  Embeddings
        ...
        *   [Interacting with Embeddings deployed in Vertex AI Endpoint with LlamaIndex](https://docs.llamaindex.ai/en/latest/examples/embeddings/vertex_embedding_endpoint/)
    ...
    *   [ ]  LLMs
        ...
        *   [EverlyAI](https://docs.llamaindex.ai/en/latest/examples/llm/everlyai/)
        ...
        *   [Vertex AI](https://docs.llamaindex.ai/en/latest/examples/llm/vertex/)
    ...
    *   [ ]  Managed Indexes
        ...
        *   [BGEM3Demo](https://docs.llamaindex.ai/en/latest/examples/managed/BGEM3Demo/)
    ...
    *   [ ]  Multi-Modal
        ...
        *   [Multi-Modal RAG using Nomic Embed and Anthropic.](https://docs.llamaindex.ai/en/latest/examples/multi_modal/multi_modal_rag_nomic/)
    ...
    *   [ ]  Node Postprocessors
        ...
        *   [Sentence Embedding Optimizer](https://docs.llamaindex.ai/en/latest/examples/node_postprocessor/OptimizerDemo/)
    ...
    *   [ ]  Property Graph
        ...
        *   [Using a Property Graph Store](https://docs.llamaindex.ai/en/latest/examples/property_graph/graph_store/)
    ...
    *   [ ]  Retrievers
        ...
        *   [Recursive Retriever + Node References](https://docs.llamaindex.ai/en/latest/examples/retrievers/recursive_retriever_nodes/)
    ...
    *   [ ]  Vector Stores
        ...
        *   [Baidu VectorDB](https://docs.llamaindex.ai/en/latest/examples/vector_stores/BaiduVectorDBIndexDemo/)
        ...
        *   [ObjectBox VectorStore Demo](https://docs.llamaindex.ai/en/latest/examples/vector_stores/ObjectBoxIndexDemo/)
        ...
        *   [Auto-Retrieval from a Vector Database](https://docs.llamaindex.ai/en/latest/examples/vector_stores/chroma_auto_retriever/)
...
*   [ ] 
    ...
    *   [ ] 
        ...
        *   [ ] 
            ...
            [Data Connectors](https://docs.llamaindex.ai/en/latest/module_guides/loading/connector/)
    ...
    *   [ ] 
        ...
        *   [ ] 
            ...
            *   [Response Synthesis Modules](https://docs.llamaindex.ai/en/latest/module_guides/querying/response_synthesizers/response_synthesizers/)
...
*   [ ]  Advanced Topics
    ...
    *   [Fine-Tuning](https://docs.llamaindex.ai/en/latest/optimizing/fine-tuning/fine-tuning/)
...
*   [ ] 
    ...
    *   [ ] 
        ...
        [Agents](https://docs.llamaindex.ai/en/latest/api_reference/agent/)
        
        Agents
        
        *   [Coa](https://docs.llamaindex.ai/en/latest/api_reference/agent/coa/)
        *   [Dashscope](https://docs.llamaindex.ai/en/latest/api_reference/agent/dashscope/)
        *   [Introspective](https://docs.llamaindex.ai/en/latest/api_reference/agent/introspective/)
        *   [Lats](https://docs.llamaindex.ai/en/latest/api_reference/agent/lats/)
        *   [Llm compiler](https://docs.llamaindex.ai/en/latest/api_reference/agent/llm_compiler/)
        *   [Openai](https://docs.llamaindex.ai/en/latest/api_reference/agent/openai/)
        *   [Openai legacy](https://docs.llamaindex.ai/en/latest/api_reference/agent/openai_legacy/)
        *   [React](https://docs.llamaindex.ai/en/latest/api_reference/agent/react/)
        *   [Workflow](https://docs.llamaindex.ai/en/latest/api_reference/agent/workflow/)
        
    *   [ ] 
        
        [Callbacks](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/)
        
        Callbacks
        
        *   [Agentops](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/agentops/)
        *   [Aim](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/aim/)
        *   [Argilla](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/argilla/)
        *   [Arize phoenix](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/arize_phoenix/)
        *   [Deepeval](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/deepeval/)
        *   [Honeyhive](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/honeyhive/)
        *   [Langfuse](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/langfuse/)
        *   [Literalai](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/literalai/)
        *   [Llama debug](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/llama_debug/)
        *   [Openinference](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/openinference/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/opentelemetry.md)
        *   [Opik](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/opik/)
        *   [Promptlayer](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/promptlayer/)
        *   [Token counter](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/token_counter/)
        *   [Uptrain](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/uptrain/)
        *   [Wandb](https://docs.llamaindex.ai/en/latest/api_reference/callbacks/wandb/)
        
    *   [ ] 
        
        [Chat Engines](https://docs.llamaindex.ai/en/latest/api_reference/chat_engines/)
        
        Chat Engines
        
        *   [Condense plus context](https://docs.llamaindex.ai/en/latest/api_reference/chat_engines/condense_plus_context/)
        *   [Condense question](https://docs.llamaindex.ai/en/latest/api_reference/chat_engines/condense_question/)
        *   [Context](https://docs.llamaindex.ai/en/latest/api_reference/chat_engines/context/)
        *   [Simple](https://docs.llamaindex.ai/en/latest/api_reference/chat_engines/simple/)
        
    *   [ ] 
        
        [Embeddings](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/)
        
        Embeddings
        
        *   [Adapter](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/adapter/)
        *   [Alephalpha](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/alephalpha/)
        *   [Alibabacloud aisearch](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/alibabacloud_aisearch/)
        *   [Anyscale](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/anyscale/)
        *   [Azure inference](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/azure_inference/)
        *   [Azure openai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/azure_openai/)
        *   [Bedrock](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/bedrock/)
        *   [Clarifai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/clarifai/)
        *   [Clip](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/clip/)
        *   [Cloudflare workersai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/cloudflare_workersai/)
        *   [Cohere](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/cohere/)
        *   [Dashscope](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/dashscope/)
        *   [Databricks](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/databricks/)
        *   [Deepinfra](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/deepinfra/)
        *   [Elasticsearch](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/elasticsearch/)
        *   [Fastembed](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/fastembed/)
        *   [Fireworks](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/fireworks/)
        *   [Gaudi](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/gaudi/)
        *   [Gemini](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/gemini/)
        *   [Gigachat](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/gigachat/)
        *   [Google](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/google/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/gradient.md)
        *   [Huggingface](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/huggingface/)
        *   [Huggingface api](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/huggingface_api/)
        *   [Huggingface openvino](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/huggingface_openvino/)
        *   [Huggingface optimum](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/huggingface_optimum/)
        *   [Huggingface optimum intel](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/huggingface_optimum_intel/)
        *   [Ibm](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/ibm/)
        *   [Instructor](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/instructor/)
        *   [Ipex llm](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/ipex_llm/)
        *   [Jinaai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/jinaai/)
        *   [Langchain](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/langchain/)
        *   [Litellm](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/litellm/)
        *   [Llamafile](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/llamafile/)
        *   [Llm rails](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/llm_rails/)
        *   [Mistralai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/mistralai/)
        *   [Mixedbreadai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/mixedbreadai/)
        *   [Modelscope](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/modelscope/)
        *   [Nebius](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/nebius/)
        *   [Nomic](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/nomic/)
        *   [Nvidia](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/nvidia/)
        *   [Oci genai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/oci_genai/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/octoai.md)
        *   [Ollama](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/ollama/)
        *   [Opea](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/opea/)
        *   [Openai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/openai/)
        *   [Oracleai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/oracleai/)
        *   [Premai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/premai/)
        *   [Sagemaker endpoint](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/sagemaker_endpoint/)
        *   [Siliconflow](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/siliconflow/)
        *   [Text embeddings inference](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/text_embeddings_inference/)
        *   [Textembed](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/textembed/)
        *   [Together](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/together/)
        *   [Upstage](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/upstage/)
        *   [Vertex](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/vertex/)
        *   [Vertex endpoint](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/vertex_endpoint/)
        *   [Voyageai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/voyageai/)
        *   [Xinference](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/xinference/)
        *   [Yandexgpt](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/yandexgpt/)
        *   [Zhipuai](https://docs.llamaindex.ai/en/latest/api_reference/embeddings/zhipuai/)
        
    *   [ ] 
        
        [Evaluation](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/)
        
        Evaluation
        
        *   [Answer relevancy](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/answer_relevancy/)
        *   [Context relevancy](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/context_relevancy/)
        *   [Correctness](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/correctness/)
        *   [Dataset generation](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/dataset_generation/)
        *   [Faithfullness](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/faithfullness/)
        *   [Guideline](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/guideline/)
        *   [Metrics](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/metrics/)
        *   [Multi modal](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/multi_modal/)
        *   [Pairwise comparison](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/pairwise_comparison/)
        *   [Query response](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/query_response/)
        *   [Response](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/response/)
        *   [Retrieval](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/retrieval/)
        *   [Semantic similarity](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/semantic_similarity/)
        *   [Tonic validate](https://docs.llamaindex.ai/en/latest/api_reference/evaluation/tonic_validate/)
        
    *   [ ]  Graph RAG
        
        Graph RAG
        
        *   [Cognee](https://docs.llamaindex.ai/en/latest/api_reference/graph_rag/cognee/)
        
    *   [ ] 
        
        [Indexes](https://docs.llamaindex.ai/en/latest/api_reference/indices/)
        
        Indexes
        
        *   [Bge m3](https://docs.llamaindex.ai/en/latest/api_reference/indices/bge_m3/)
        *   [Colbert](https://docs.llamaindex.ai/en/latest/api_reference/indices/colbert/)
        *   [Dashscope](https://docs.llamaindex.ai/en/latest/api_reference/indices/dashscope/)
        *   [Document summary](https://docs.llamaindex.ai/en/latest/api_reference/indices/document_summary/)
        *   [Google](https://docs.llamaindex.ai/en/latest/api_reference/indices/google/)
        *   [Keyword](https://docs.llamaindex.ai/en/latest/api_reference/indices/keyword/)
        *   [Knowledge graph](https://docs.llamaindex.ai/en/latest/api_reference/indices/knowledge_graph/)
        *   [Llama cloud](https://docs.llamaindex.ai/en/latest/api_reference/indices/llama_cloud/)
        *   [Postgresml](https://docs.llamaindex.ai/en/latest/api_reference/indices/postgresml/)
        *   [Property graph](https://docs.llamaindex.ai/en/latest/api_reference/indices/property_graph/)
        *   [Summary](https://docs.llamaindex.ai/en/latest/api_reference/indices/summary/)
        *   [Tree](https://docs.llamaindex.ai/en/latest/api_reference/indices/tree/)
        *   [Vectara](https://docs.llamaindex.ai/en/latest/api_reference/indices/vectara/)
        *   [Vector](https://docs.llamaindex.ai/en/latest/api_reference/indices/vector/)
        *   [Vertexai](https://docs.llamaindex.ai/en/latest/api_reference/indices/vertexai/)
        *   [Zilliz](https://docs.llamaindex.ai/en/latest/api_reference/indices/zilliz/)
        
    *   [ ] 
        
        [Ingestion](https://docs.llamaindex.ai/en/latest/api_reference/ingestion/)
        
        Ingestion
        
    *   [ ] 
        
        [Instrumentation](https://docs.llamaindex.ai/en/latest/api_reference/instrumentation/)
        
        Instrumentation
        
        *   [Event handlers](https://docs.llamaindex.ai/en/latest/api_reference/instrumentation/event_handlers/)
        *   [Event types](https://docs.llamaindex.ai/en/latest/api_reference/instrumentation/event_types/)
        *   [Span handlers](https://docs.llamaindex.ai/en/latest/api_reference/instrumentation/span_handlers/)
        *   [Span types](https://docs.llamaindex.ai/en/latest/api_reference/instrumentation/span_types/)
        
    *   [ ] 
        
        [LLMs](https://docs.llamaindex.ai/en/latest/api_reference/llms/)
        
        LLMs
        
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/llms/OptimumIntelLLM.md)
        *   [Ai21](https://docs.llamaindex.ai/en/latest/api_reference/llms/ai21/)
        *   [Alephalpha](https://docs.llamaindex.ai/en/latest/api_reference/llms/alephalpha/)
        *   [Alibabacloud aisearch](https://docs.llamaindex.ai/en/latest/api_reference/llms/alibabacloud_aisearch/)
        *   [Anthropic](https://docs.llamaindex.ai/en/latest/api_reference/llms/anthropic/)
        *   [Anyscale](https://docs.llamaindex.ai/en/latest/api_reference/llms/anyscale/)
        *   [Azure inference](https://docs.llamaindex.ai/en/latest/api_reference/llms/azure_inference/)
        *   [Azure openai](https://docs.llamaindex.ai/en/latest/api_reference/llms/azure_openai/)
        *   [Bedrock](https://docs.llamaindex.ai/en/latest/api_reference/llms/bedrock/)
        *   [Bedrock converse](https://docs.llamaindex.ai/en/latest/api_reference/llms/bedrock_converse/)
        *   [Cerebras](https://docs.llamaindex.ai/en/latest/api_reference/llms/cerebras/)
        *   [Clarifai](https://docs.llamaindex.ai/en/latest/api_reference/llms/clarifai/)
        *   [Cleanlab](https://docs.llamaindex.ai/en/latest/api_reference/llms/cleanlab/)
        *   [Cohere](https://docs.llamaindex.ai/en/latest/api_reference/llms/cohere/)
        *   [Custom llm](https://docs.llamaindex.ai/en/latest/api_reference/llms/custom_llm/)
        *   [Dashscope](https://docs.llamaindex.ai/en/latest/api_reference/llms/dashscope/)
        *   [Databricks](https://docs.llamaindex.ai/en/latest/api_reference/llms/databricks/)
        *   [Deepinfra](https://docs.llamaindex.ai/en/latest/api_reference/llms/deepinfra/)
        *   [Everlyai](https://docs.llamaindex.ai/en/latest/api_reference/llms/everlyai/)
        *   [Fireworks](https://docs.llamaindex.ai/en/latest/api_reference/llms/fireworks/)
        *   [Friendli](https://docs.llamaindex.ai/en/latest/api_reference/llms/friendli/)
        *   [Gaudi](https://docs.llamaindex.ai/en/latest/api_reference/llms/gaudi/)
        *   [Gemini](https://docs.llamaindex.ai/en/latest/api_reference/llms/gemini/)
        *   [Gigachat](https://docs.llamaindex.ai/en/latest/api_reference/llms/gigachat/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/llms/gradient.md)
        *   [Groq](https://docs.llamaindex.ai/en/latest/api_reference/llms/groq/)
        *   [Huggingface](https://docs.llamaindex.ai/en/latest/api_reference/llms/huggingface/)
        *   [Huggingface api](https://docs.llamaindex.ai/en/latest/api_reference/llms/huggingface_api/)
        *   [Ibm](https://docs.llamaindex.ai/en/latest/api_reference/llms/ibm/)
        *   [Ipex llm](https://docs.llamaindex.ai/en/latest/api_reference/llms/ipex_llm/)
        *   [Keywordsai](https://docs.llamaindex.ai/en/latest/api_reference/llms/keywordsai/)
        *   [Konko](https://docs.llamaindex.ai/en/latest/api_reference/llms/konko/)
        *   [Langchain](https://docs.llamaindex.ai/en/latest/api_reference/llms/langchain/)
        *   [Litellm](https://docs.llamaindex.ai/en/latest/api_reference/llms/litellm/)
        *   [Llama api](https://docs.llamaindex.ai/en/latest/api_reference/llms/llama_api/)
        *   [Llama cpp](https://docs.llamaindex.ai/en/latest/api_reference/llms/llama_cpp/)
        *   [Llamafile](https://docs.llamaindex.ai/en/latest/api_reference/llms/llamafile/)
        *   [Lmstudio](https://docs.llamaindex.ai/en/latest/api_reference/llms/lmstudio/)
        *   [Localai](https://docs.llamaindex.ai/en/latest/api_reference/llms/localai/)
        *   [Maritalk](https://docs.llamaindex.ai/en/latest/api_reference/llms/maritalk/)
        *   [Mistral rs](https://docs.llamaindex.ai/en/latest/api_reference/llms/mistral_rs/)
        *   [Mistralai](https://docs.llamaindex.ai/en/latest/api_reference/llms/mistralai/)
        *   [Mlx](https://docs.llamaindex.ai/en/latest/api_reference/llms/mlx/)
        *   [Modelscope](https://docs.llamaindex.ai/en/latest/api_reference/llms/modelscope/)
        *   [Monsterapi](https://docs.llamaindex.ai/en/latest/api_reference/llms/monsterapi/)
        *   [Mymagic](https://docs.llamaindex.ai/en/latest/api_reference/llms/mymagic/)
        *   [Nebius](https://docs.llamaindex.ai/en/latest/api_reference/llms/nebius/)
        *   [Neutrino](https://docs.llamaindex.ai/en/latest/api_reference/llms/neutrino/)
        *   [Nvidia](https://docs.llamaindex.ai/en/latest/api_reference/llms/nvidia/)
        *   [Nvidia tensorrt](https://docs.llamaindex.ai/en/latest/api_reference/llms/nvidia_tensorrt/)
        *   [Nvidia triton](https://docs.llamaindex.ai/en/latest/api_reference/llms/nvidia_triton/)
        *   [Oci genai](https://docs.llamaindex.ai/en/latest/api_reference/llms/oci_genai/)
        *   [Octoai](https://docs.llamaindex.ai/en/latest/api_reference/llms/octoai/)
        *   [Ollama](https://docs.llamaindex.ai/en/latest/api_reference/llms/ollama/)
        *   [Opea](https://docs.llamaindex.ai/en/latest/api_reference/llms/opea/)
        *   [Openai](https://docs.llamaindex.ai/en/latest/api_reference/llms/openai/)
        *   [Openai like](https://docs.llamaindex.ai/en/latest/api_reference/llms/openai_like/)
        *   [Openllm](https://docs.llamaindex.ai/en/latest/api_reference/llms/openllm/)
        *   [Openrouter](https://docs.llamaindex.ai/en/latest/api_reference/llms/openrouter/)
        *   [Openvino](https://docs.llamaindex.ai/en/latest/api_reference/llms/openvino/)
        *   [Optimum intel](https://docs.llamaindex.ai/en/latest/api_reference/llms/optimum_intel/)
        *   [Paieas](https://docs.llamaindex.ai/en/latest/api_reference/llms/paieas/)
        *   [Palm](https://docs.llamaindex.ai/en/latest/api_reference/llms/palm/)
        *   [Perplexity](https://docs.llamaindex.ai/en/latest/api_reference/llms/perplexity/)
        *   [Pipeshift](https://docs.llamaindex.ai/en/latest/api_reference/llms/pipeshift/)
        *   [Portkey](https://docs.llamaindex.ai/en/latest/api_reference/llms/portkey/)
        *   [Predibase](https://docs.llamaindex.ai/en/latest/api_reference/llms/predibase/)
        *   [Premai](https://docs.llamaindex.ai/en/latest/api_reference/llms/premai/)
        *   [Qianfan](https://docs.llamaindex.ai/en/latest/api_reference/llms/qianfan/)
        *   [Reka](https://docs.llamaindex.ai/en/latest/api_reference/llms/reka/)
        *   [Replicate](https://docs.llamaindex.ai/en/latest/api_reference/llms/replicate/)
        *   [Rungpt](https://docs.llamaindex.ai/en/latest/api_reference/llms/rungpt/)
        *   [Sagemaker endpoint](https://docs.llamaindex.ai/en/latest/api_reference/llms/sagemaker_endpoint/)
        *   [Sambanovasystems](https://docs.llamaindex.ai/en/latest/api_reference/llms/sambanovasystems/)
        *   [Siliconflow](https://docs.llamaindex.ai/en/latest/api_reference/llms/siliconflow/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/llms/solar.md)
        *   [Stepfun](https://docs.llamaindex.ai/en/latest/api_reference/llms/stepfun/)
        *   [Text generation inference](https://docs.llamaindex.ai/en/latest/api_reference/llms/text_generation_inference/)
        *   [Together](https://docs.llamaindex.ai/en/latest/api_reference/llms/together/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/llms/unify.md)
        *   [Upstage](https://docs.llamaindex.ai/en/latest/api_reference/llms/upstage/)
        *   [Vertex](https://docs.llamaindex.ai/en/latest/api_reference/llms/vertex/)
        *   [Vllm](https://docs.llamaindex.ai/en/latest/api_reference/llms/vllm/)
        *   [Xinference](https://docs.llamaindex.ai/en/latest/api_reference/llms/xinference/)
        *   [Yi](https://docs.llamaindex.ai/en/latest/api_reference/llms/yi/)
        *   [You](https://docs.llamaindex.ai/en/latest/api_reference/llms/you/)
        *   [Zhipuai](https://docs.llamaindex.ai/en/latest/api_reference/llms/zhipuai/)
        
    *   [ ] 
        
        [Llama Datasets](https://docs.llamaindex.ai/en/latest/api_reference/llama_dataset/)
    ...
    *   [ ]  Llama Deploy
        ...
        *   [apiserver](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/apiserver/)
        *   [control\_plane](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/control_plane/)
        *   [deploy](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/deploy/)
        *   [message\_consumers](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/message_consumers/)
        *   [message\_publishers](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/message_publishers/)
        *   [messages](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/messages/)
        *   [orchestrators](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/orchestrators/)
        *   [Python SDK](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/python_sdk/)
        *   [services](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/services/)
        *   [types](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/types/)
        *   [ ] 
            
            [message\_queues](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/message_queues/)
            
            message\_queues
            
            *   [apache\_kafka](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/message_queues/kafka/)
            *   [rabbitmq](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/message_queues/rabbitmq/)
            *   [redis](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/message_queues/redis/)
            *   [simple](https://docs.llamaindex.ai/en/latest/api_reference/llama_deploy/message_queues/simple/)
            
        
    *   [ ] 
        
        [Llama Packs](https://docs.llamaindex.ai/en/latest/api_reference/packs/)
        
        Llama Packs
        
        *   [Agent search retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/agent_search_retriever/)
        *   [Agents coa](https://docs.llamaindex.ai/en/latest/api_reference/packs/agents_coa/)
        *   [Agents lats](https://docs.llamaindex.ai/en/latest/api_reference/packs/agents_lats/)
        *   [Agents llm compiler](https://docs.llamaindex.ai/en/latest/api_reference/packs/agents_llm_compiler/)
        *   [Amazon product extraction](https://docs.llamaindex.ai/en/latest/api_reference/packs/amazon_product_extraction/)
        *   [Arize phoenix query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/arize_phoenix_query_engine/)
        *   [Auto merging retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/auto_merging_retriever/)
        *   [Chroma autoretrieval](https://docs.llamaindex.ai/en/latest/api_reference/packs/chroma_autoretrieval/)
        *   [Code hierarchy](https://docs.llamaindex.ai/en/latest/api_reference/packs/code_hierarchy/)
        *   [Cogniswitch agent](https://docs.llamaindex.ai/en/latest/api_reference/packs/cogniswitch_agent/)
        *   [Cohere citation chat](https://docs.llamaindex.ai/en/latest/api_reference/packs/cohere_citation_chat/)
        *   [Corrective rag](https://docs.llamaindex.ai/en/latest/api_reference/packs/corrective_rag/)
        *   [Deeplake deepmemory retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/deeplake_deepmemory_retriever/)
        *   [Deeplake multimodal retrieval](https://docs.llamaindex.ai/en/latest/api_reference/packs/deeplake_multimodal_retrieval/)
        *   [Dense x retrieval](https://docs.llamaindex.ai/en/latest/api_reference/packs/dense_x_retrieval/)
        *   [Diff private simple dataset](https://docs.llamaindex.ai/en/latest/api_reference/packs/diff_private_simple_dataset/)
        *   [Evaluator benchmarker](https://docs.llamaindex.ai/en/latest/api_reference/packs/evaluator_benchmarker/)
        *   [Fusion retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/fusion_retriever/)
        *   [Fuzzy citation](https://docs.llamaindex.ai/en/latest/api_reference/packs/fuzzy_citation/)
        *   [Gmail openai agent](https://docs.llamaindex.ai/en/latest/api_reference/packs/gmail_openai_agent/)
        *   [Gradio agent chat](https://docs.llamaindex.ai/en/latest/api_reference/packs/gradio_agent_chat/)
        *   [Gradio react agent chatbot](https://docs.llamaindex.ai/en/latest/api_reference/packs/gradio_react_agent_chatbot/)
        *   [Infer retrieve rerank](https://docs.llamaindex.ai/en/latest/api_reference/packs/infer_retrieve_rerank/)
        *   [Koda retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/koda_retriever/)
        *   [Llama dataset metadata](https://docs.llamaindex.ai/en/latest/api_reference/packs/llama_dataset_metadata/)
        *   [Llama guard moderator](https://docs.llamaindex.ai/en/latest/api_reference/packs/llama_guard_moderator/)
        *   [Llava completion](https://docs.llamaindex.ai/en/latest/api_reference/packs/llava_completion/)
        *   [Longrag](https://docs.llamaindex.ai/en/latest/api_reference/packs/longrag/)
        *   [Mixture of agents](https://docs.llamaindex.ai/en/latest/api_reference/packs/mixture_of_agents/)
        *   [Multi document agents](https://docs.llamaindex.ai/en/latest/api_reference/packs/multi_document_agents/)
        *   [Multi tenancy rag](https://docs.llamaindex.ai/en/latest/api_reference/packs/multi_tenancy_rag/)
        *   [Multidoc autoretrieval](https://docs.llamaindex.ai/en/latest/api_reference/packs/multidoc_autoretrieval/)
        *   [Nebulagraph query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/nebulagraph_query_engine/)
        *   [Neo4j query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/neo4j_query_engine/)
        *   [Node parser semantic chunking](https://docs.llamaindex.ai/en/latest/api_reference/packs/node_parser_semantic_chunking/)
        *   [Ollama query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/ollama_query_engine/)
        *   [Panel chatbot](https://docs.llamaindex.ai/en/latest/api_reference/packs/panel_chatbot/)
        *   [Query understanding agent](https://docs.llamaindex.ai/en/latest/api_reference/packs/query_understanding_agent/)
        *   [Raft dataset](https://docs.llamaindex.ai/en/latest/api_reference/packs/raft_dataset/)
        *   [Rag cli local](https://docs.llamaindex.ai/en/latest/api_reference/packs/rag_cli_local/)
        *   [Rag evaluator](https://docs.llamaindex.ai/en/latest/api_reference/packs/rag_evaluator/)
        *   [Rag fusion query pipeline](https://docs.llamaindex.ai/en/latest/api_reference/packs/rag_fusion_query_pipeline/)
        *   [Ragatouille retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/ragatouille_retriever/)
        *   [Raptor](https://docs.llamaindex.ai/en/latest/api_reference/packs/raptor/)
        *   [Recursive retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/recursive_retriever/)
        *   [Resume screener](https://docs.llamaindex.ai/en/latest/api_reference/packs/resume_screener/)
        *   [Retry engine weaviate](https://docs.llamaindex.ai/en/latest/api_reference/packs/retry_engine_weaviate/)
        *   [Secgpt](https://docs.llamaindex.ai/en/latest/api_reference/packs/secgpt/)
        *   [Self discover](https://docs.llamaindex.ai/en/latest/api_reference/packs/self_discover/)
        *   [Self rag](https://docs.llamaindex.ai/en/latest/api_reference/packs/self_rag/)
        *   [Sentence window retriever](https://docs.llamaindex.ai/en/latest/api_reference/packs/sentence_window_retriever/)
        *   [Snowflake query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/snowflake_query_engine/)
        *   [Stock market data query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/stock_market_data_query_engine/)
        *   [Streamlit chatbot](https://docs.llamaindex.ai/en/latest/api_reference/packs/streamlit_chatbot/)
        *   [Sub question weaviate](https://docs.llamaindex.ai/en/latest/api_reference/packs/sub_question_weaviate/)
        *   [Tables](https://docs.llamaindex.ai/en/latest/api_reference/packs/tables/)
        *   [Timescale vector autoretrieval](https://docs.llamaindex.ai/en/latest/api_reference/packs/timescale_vector_autoretrieval/)
        *   [Trulens eval packs](https://docs.llamaindex.ai/en/latest/api_reference/packs/trulens_eval_packs/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/packs/vanna.md)
        *   [Vectara rag](https://docs.llamaindex.ai/en/latest/api_reference/packs/vectara_rag/)
        *   [Voyage query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/voyage_query_engine/)
        *   [Zenguard](https://docs.llamaindex.ai/en/latest/api_reference/packs/zenguard/)
        *   [Zephyr query engine](https://docs.llamaindex.ai/en/latest/api_reference/packs/zephyr_query_engine/)
        
    *   [ ] 
        
        [Memory](https://docs.llamaindex.ai/en/latest/api_reference/memory/)
        
        Memory
        
        *   [Chat memory buffer](https://docs.llamaindex.ai/en/latest/api_reference/memory/chat_memory_buffer/)
        *   [Mem0](https://docs.llamaindex.ai/en/latest/api_reference/memory/mem0/)
        *   [Simple composable memory](https://docs.llamaindex.ai/en/latest/api_reference/memory/simple_composable_memory/)
        *   [Vector memory](https://docs.llamaindex.ai/en/latest/api_reference/memory/vector_memory/)
        
    *   [ ] 
        
        [Metadata Extractors](https://docs.llamaindex.ai/en/latest/api_reference/extractors/)
        
        Metadata Extractors
        
        *   [Entity](https://docs.llamaindex.ai/en/latest/api_reference/extractors/entity/)
        *   [Keyword](https://docs.llamaindex.ai/en/latest/api_reference/extractors/keyword/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/extractors/llama_extract.md)
        *   [Marvin](https://docs.llamaindex.ai/en/latest/api_reference/extractors/marvin/)
        *   [Pydantic](https://docs.llamaindex.ai/en/latest/api_reference/extractors/pydantic/)
        *   [Question](https://docs.llamaindex.ai/en/latest/api_reference/extractors/question/)
        *   [Relik](https://docs.llamaindex.ai/en/latest/api_reference/extractors/relik/)
        *   [Summary](https://docs.llamaindex.ai/en/latest/api_reference/extractors/summary/)
        *   [Title](https://docs.llamaindex.ai/en/latest/api_reference/extractors/title/)
        
    *   [ ] 
        
        [Multi-Modal LLMs](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/)
        
        Multi-Modal LLMs
        
        *   [Anthropic](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/anthropic/)
        *   [Azure openai](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/azure_openai/)
        *   [Bedrock](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/bedrock/)
        *   [Dashscope](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/dashscope/)
        *   [Gemini](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/gemini/)
        *   [Huggingface](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/huggingface/)
        *   [Mistralai](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/mistralai/)
        *   [Nebius](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/nebius/)
        *   [Nvidia](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/nvidia/)
        *   [Ollama](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/ollama/)
        *   [Openai](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/openai/)
        *   [Openvino](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/openvino/)
        *   [Reka](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/reka/)
        *   [Replicate](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/replicate/)
        *   [Zhipuai](https://docs.llamaindex.ai/en/latest/api_reference/multi_modal_llms/zhipuai/)
        
    *   [ ] 
        
        [Node Parsers & Text Splitters](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/)
        
        Node Parsers & Text Splitters
        
        *   [Alibabacloud aisearch](https://docs.llamaindex.ai/en/latest/api_reference/node_parser/alibabacloud_aisearch/)
        *   [Dashscope](https://docs.llamaindex.ai/en/latest/api_reference/node_parser/dashscope/)
        *   [Docling](https://docs.llamaindex.ai/en/latest/api_reference/node_parser/docling/)
        *   [Topic](https://docs.llamaindex.ai/en/latest/api_reference/node_parser/topic/)
        *   [Code](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/code/)
        *   [Hierarchical](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/hierarchical/)
        *   [Html](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/html/)
        *   [Json](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/json/)
        *   [Langchain](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/langchain/)
        *   [Markdown](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/markdown/)
        *   [Markdown element](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/markdown_element/)
        *   [Semantic splitter](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/semantic_splitter/)
        *   [Sentence splitter](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/sentence_splitter/)
        *   [Sentence window](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/sentence_window/)
        *   [Token text splitter](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/token_text_splitter/)
        *   [Unstructured element](https://docs.llamaindex.ai/en/latest/api_reference/node_parsers/unstructured_element/)
        
    *   [ ] 
        
        [Node Postprocessors](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/)
        
        Node Postprocessors
        
        *   [NER PII](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/NER_PII/)
        *   [PII](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/PII/)
        *   [Alibabacloud aisearch rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/alibabacloud_aisearch_rerank/)
        *   [Auto prev next](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/auto_prev_next/)
        *   [Bedrock rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/bedrock_rerank/)
        *   [Cohere rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/cohere_rerank/)
        *   [Colbert rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/colbert_rerank/)
        *   [Colpali rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/colpali_rerank/)
        *   [Dashscope rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/dashscope_rerank/)
        *   [Embedding recency](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/embedding_recency/)
        *   [Fixed recency](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/fixed_recency/)
        *   [Flag embedding reranker](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/flag_embedding_reranker/)
        *   [Jinaai rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/jinaai_rerank/)
        *   [Keyword](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/keyword/)
        *   [Llm rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/llm_rerank/)
        *   [Long context reorder](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/long_context_reorder/)
        *   [Longllmlingua](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/longllmlingua/)
        *   [Metadata replacement](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/metadata_replacement/)
        *   [Mixedbreadai rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/mixedbreadai_rerank/)
        *   [Nvidia rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/nvidia_rerank/)
        *   [Openvino rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/openvino_rerank/)
        *   [Pinecone native rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/pinecone_native_rerank/)
        *   [Presidio](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/presidio/)
        *   [Prev next](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/prev_next/)
        *   [Rankgpt rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/rankgpt_rerank/)
        *   [Rankllm rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/rankllm_rerank/)
        *   [Sbert rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/sbert_rerank/)
        *   [Sentence optimizer](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/sentence_optimizer/)
        *   [Siliconflow rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/siliconflow_rerank/)
        *   [Similarity](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/similarity/)
        *   [Tei rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/tei_rerank/)
        *   [Time weighted](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/time_weighted/)
        *   [Voyageai rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/voyageai_rerank/)
        *   [Xinference rerank](https://docs.llamaindex.ai/en/latest/api_reference/postprocessor/xinference_rerank/)
        
    *   [ ] 
        
        [Object Stores](https://docs.llamaindex.ai/en/latest/api_reference/objects/)
        
        Object Stores
        
    *   [ ] 
        
        [Output Parsers](https://docs.llamaindex.ai/en/latest/api_reference/output_parsers/)
        
        Output Parsers
        
        *   [Guardrails](https://docs.llamaindex.ai/en/latest/api_reference/output_parsers/guardrails/)
        *   [Langchain](https://docs.llamaindex.ai/en/latest/api_reference/output_parsers/langchain/)
        *   [Pydantic](https://docs.llamaindex.ai/en/latest/api_reference/output_parsers/pydantic/)
        *   [Selection](https://docs.llamaindex.ai/en/latest/api_reference/output_parsers/selection/)
        
    *   [ ] 
        
        [Programs](https://docs.llamaindex.ai/en/latest/api_reference/program/)
        
        Programs
        
        *   [Evaporate](https://docs.llamaindex.ai/en/latest/api_reference/program/evaporate/)
        *   [Guidance](https://docs.llamaindex.ai/en/latest/api_reference/program/guidance/)
        *   [Llm text completion](https://docs.llamaindex.ai/en/latest/api_reference/program/llm_text_completion/)
        *   [Lmformatenforcer](https://docs.llamaindex.ai/en/latest/api_reference/program/lmformatenforcer/)
        *   [Multi modal](https://docs.llamaindex.ai/en/latest/api_reference/program/multi_modal/)
        *   [Openai](https://docs.llamaindex.ai/en/latest/api_reference/program/openai/)
        
    *   [ ] 
        
        [Prompts](https://docs.llamaindex.ai/en/latest/api_reference/prompts/)
        
        Prompts
        
    *   [ ] 
        
        [Query Engines](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/)
        
        Query Engines
        
        *   [FLARE](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/FLARE/)
        *   [JSONalayze](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/JSONalayze/)
        *   [NL SQL table](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/NL_SQL_table/)
        *   [PGVector SQL](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/PGVector_SQL/)
        *   [SQL join](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/SQL_join/)
        *   [SQL table retriever](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/SQL_table_retriever/)
        *   [Citation](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/citation/)
        *   [Cogniswitch](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/cogniswitch/)
        *   [Custom](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/custom/)
        *   [Knowledge graph](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/knowledge_graph/)
        *   [Multi step](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/multi_step/)
        *   [Pandas](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/pandas/)
        *   [Retriever](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/retriever/)
        *   [Retriever router](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/retriever_router/)
        *   [Retry](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/retry/)
        *   [Router](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/router/)
        *   [Simple multi modal](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/simple_multi_modal/)
        *   [Sub question](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/sub_question/)
        *   [Tool retriever router](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/tool_retriever_router/)
        *   [Transform](https://docs.llamaindex.ai/en/latest/api_reference/query_engine/transform/)
        
    *   [ ] 
        
        [Query Pipeline](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/)
        
        Query Pipeline
        
        *   [Agent](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/agent/)
        *   [Arg pack](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/arg_pack/)
        *   [Custom](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/custom/)
        *   [Function](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/function/)
        *   [Input](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/input/)
        *   [Llm](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/llm/)
        *   [Multi modal](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/multi_modal/)
        *   [Object](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/object/)
        *   [Output parser](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/output_parser/)
        *   [Postprocessor](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/postprocessor/)
        *   [Prompt](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/prompt/)
        *   [Query engine](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/query_engine/)
        *   [Query transform](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/query_transform/)
        *   [Retriever](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/retriever/)
        *   [Router](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/router/)
        *   [Synthesizer](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/synthesizer/)
        *   [Tool runner](https://docs.llamaindex.ai/en/latest/api_reference/query_pipeline/tool_runner/)
        
    *   [ ] 
        
        [Question Generators](https://docs.llamaindex.ai/en/latest/api_reference/question_gen/)
        
        Question Generators
        
        *   [Guidance](https://docs.llamaindex.ai/en/latest/api_reference/question_gen/guidance/)
        *   [Llm question gen](https://docs.llamaindex.ai/en/latest/api_reference/question_gen/llm_question_gen/)
        *   [Openai](https://docs.llamaindex.ai/en/latest/api_reference/question_gen/openai/)
        
    *   [ ] 
        
        [Readers](https://docs.llamaindex.ai/en/latest/api_reference/readers/)
        
        Readers
        
        *   [Agent search](https://docs.llamaindex.ai/en/latest/api_reference/readers/agent_search/)
        *   [Airbyte cdk](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_cdk/)
        *   [Airbyte gong](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_gong/)
        *   [Airbyte hubspot](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_hubspot/)
        *   [Airbyte salesforce](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_salesforce/)
        *   [Airbyte shopify](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_shopify/)
        *   [Airbyte stripe](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_stripe/)
        *   [Airbyte typeform](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_typeform/)
        *   [Airbyte zendesk support](https://docs.llamaindex.ai/en/latest/api_reference/readers/airbyte_zendesk_support/)
        *   [Airtable](https://docs.llamaindex.ai/en/latest/api_reference/readers/airtable/)
        *   [Alibabacloud aisearch](https://docs.llamaindex.ai/en/latest/api_reference/readers/alibabacloud_aisearch/)
        *   [Apify](https://docs.llamaindex.ai/en/latest/api_reference/readers/apify/)
        *   [Arango db](https://docs.llamaindex.ai/en/latest/api_reference/readers/arango_db/)
        *   [Arxiv](https://docs.llamaindex.ai/en/latest/api_reference/readers/arxiv/)
        *   [Asana](https://docs.llamaindex.ai/en/latest/api_reference/readers/asana/)
        *   [Assemblyai](https://docs.llamaindex.ai/en/latest/api_reference/readers/assemblyai/)
        *   [Astra db](https://docs.llamaindex.ai/en/latest/api_reference/readers/astra_db/)
        *   [Athena](https://docs.llamaindex.ai/en/latest/api_reference/readers/athena/)
        *   [Awadb](https://docs.llamaindex.ai/en/latest/api_reference/readers/awadb/)
        *   [Azcognitive search](https://docs.llamaindex.ai/en/latest/api_reference/readers/azcognitive_search/)
        *   [Azstorage blob](https://docs.llamaindex.ai/en/latest/api_reference/readers/azstorage_blob/)
        *   [Bagel](https://docs.llamaindex.ai/en/latest/api_reference/readers/bagel/)
        *   [Bilibili](https://docs.llamaindex.ai/en/latest/api_reference/readers/bilibili/)
        *   [Bitbucket](https://docs.llamaindex.ai/en/latest/api_reference/readers/bitbucket/)
        *   [Boarddocs](https://docs.llamaindex.ai/en/latest/api_reference/readers/boarddocs/)
        *   [Box](https://docs.llamaindex.ai/en/latest/api_reference/readers/box/)
        *   [Chatgpt plugin](https://docs.llamaindex.ai/en/latest/api_reference/readers/chatgpt_plugin/)
        *   [Chroma](https://docs.llamaindex.ai/en/latest/api_reference/readers/chroma/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/readers/clickhouse.md)
        *   [Confluence](https://docs.llamaindex.ai/en/latest/api_reference/readers/confluence/)
        *   [Couchbase](https://docs.llamaindex.ai/en/latest/api_reference/readers/couchbase/)
        *   [Couchdb](https://docs.llamaindex.ai/en/latest/api_reference/readers/couchdb/)
        *   [Dad jokes](https://docs.llamaindex.ai/en/latest/api_reference/readers/dad_jokes/)
        *   [Dashscope](https://docs.llamaindex.ai/en/latest/api_reference/readers/dashscope/)
        *   [Dashvector](https://docs.llamaindex.ai/en/latest/api_reference/readers/dashvector/)
        *   [Database](https://docs.llamaindex.ai/en/latest/api_reference/readers/database/)
        *   [Deeplake](https://docs.llamaindex.ai/en/latest/api_reference/readers/deeplake/)
        *   [Discord](https://docs.llamaindex.ai/en/latest/api_reference/readers/discord/)
        *   [Docling](https://docs.llamaindex.ai/en/latest/api_reference/readers/docling/)
        *   [Docstring walker](https://docs.llamaindex.ai/en/latest/api_reference/readers/docstring_walker/)
        *   [Docugami](https://docs.llamaindex.ai/en/latest/api_reference/readers/docugami/)
        *   [Document360](https://docs.llamaindex.ai/en/latest/api_reference/readers/document360/)
        *   [Earnings call transcript](https://docs.llamaindex.ai/en/latest/api_reference/readers/earnings_call_transcript/)
        *   [Elasticsearch](https://docs.llamaindex.ai/en/latest/api_reference/readers/elasticsearch/)
        *   [Faiss](https://docs.llamaindex.ai/en/latest/api_reference/readers/faiss/)
        *   [Feedly rss](https://docs.llamaindex.ai/en/latest/api_reference/readers/feedly_rss/)
        *   [Feishu docs](https://docs.llamaindex.ai/en/latest/api_reference/readers/feishu_docs/)
        *   [File](https://docs.llamaindex.ai/en/latest/api_reference/readers/file/)
        *   [Firebase realtimedb](https://docs.llamaindex.ai/en/latest/api_reference/readers/firebase_realtimedb/)
        *   [Firestore](https://docs.llamaindex.ai/en/latest/api_reference/readers/firestore/)
        *   [Gcs](https://docs.llamaindex.ai/en/latest/api_reference/readers/gcs/)
        *   [Genius](https://docs.llamaindex.ai/en/latest/api_reference/readers/genius/)
        *   [Gitbook](https://docs.llamaindex.ai/en/latest/api_reference/readers/gitbook/)
        *   [Github](https://docs.llamaindex.ai/en/latest/api_reference/readers/github/)
        *   [Gitlab](https://docs.llamaindex.ai/en/latest/api_reference/readers/gitlab/)
        *   [Google](https://docs.llamaindex.ai/en/latest/api_reference/readers/google/)
        *   [Gpt repo](https://docs.llamaindex.ai/en/latest/api_reference/readers/gpt_repo/)
        *   [Graphdb cypher](https://docs.llamaindex.ai/en/latest/api_reference/readers/graphdb_cypher/)
        *   [Graphql](https://docs.llamaindex.ai/en/latest/api_reference/readers/graphql/)
        *   [Guru](https://docs.llamaindex.ai/en/latest/api_reference/readers/guru/)
        *   [Hatena blog](https://docs.llamaindex.ai/en/latest/api_reference/readers/hatena_blog/)
        *   [Hive](https://docs.llamaindex.ai/en/latest/api_reference/readers/hive/)
        *   [Hubspot](https://docs.llamaindex.ai/en/latest/api_reference/readers/hubspot/)
        *   [Huggingface fs](https://docs.llamaindex.ai/en/latest/api_reference/readers/huggingface_fs/)
        *   [Hwp](https://docs.llamaindex.ai/en/latest/api_reference/readers/hwp/)
        *   [Iceberg](https://docs.llamaindex.ai/en/latest/api_reference/readers/iceberg/)
        *   [Imdb review](https://docs.llamaindex.ai/en/latest/api_reference/readers/imdb_review/)
        *   [Intercom](https://docs.llamaindex.ai/en/latest/api_reference/readers/intercom/)
        *   [Jaguar](https://docs.llamaindex.ai/en/latest/api_reference/readers/jaguar/)
        *   [Jira](https://docs.llamaindex.ai/en/latest/api_reference/readers/jira/)
        *   [Joplin](https://docs.llamaindex.ai/en/latest/api_reference/readers/joplin/)
        *   [Json](https://docs.llamaindex.ai/en/latest/api_reference/readers/json/)
        *   [Kaltura esearch](https://docs.llamaindex.ai/en/latest/api_reference/readers/kaltura_esearch/)
        *   [Kibela](https://docs.llamaindex.ai/en/latest/api_reference/readers/kibela/)
        *   [Lilac](https://docs.llamaindex.ai/en/latest/api_reference/readers/lilac/)
        *   [Linear](https://docs.llamaindex.ai/en/latest/api_reference/readers/linear/)
        *   [Llama parse](https://docs.llamaindex.ai/en/latest/api_reference/readers/llama_parse/)
        *   [Macrometa gdn](https://docs.llamaindex.ai/en/latest/api_reference/readers/macrometa_gdn/)
        *   [Make com](https://docs.llamaindex.ai/en/latest/api_reference/readers/make_com/)
        *   [Mangadex](https://docs.llamaindex.ai/en/latest/api_reference/readers/mangadex/)
        *   [Mangoapps guides](https://docs.llamaindex.ai/en/latest/api_reference/readers/mangoapps_guides/)
        *   [Maps](https://docs.llamaindex.ai/en/latest/api_reference/readers/maps/)
        *   [Mbox](https://docs.llamaindex.ai/en/latest/api_reference/readers/mbox/)
        *   [Memos](https://docs.llamaindex.ai/en/latest/api_reference/readers/memos/)
        *   [Metal](https://docs.llamaindex.ai/en/latest/api_reference/readers/metal/)
        *   [Microsoft onedrive](https://docs.llamaindex.ai/en/latest/api_reference/readers/microsoft_onedrive/)
        *   [Microsoft outlook](https://docs.llamaindex.ai/en/latest/api_reference/readers/microsoft_outlook/)
        *   [Microsoft sharepoint](https://docs.llamaindex.ai/en/latest/api_reference/readers/microsoft_sharepoint/)
        *   [Milvus](https://docs.llamaindex.ai/en/latest/api_reference/readers/milvus/)
        *   [Minio](https://docs.llamaindex.ai/en/latest/api_reference/readers/minio/)
        *   [Mondaydotcom](https://docs.llamaindex.ai/en/latest/api_reference/readers/mondaydotcom/)
        *   [Mongodb](https://docs.llamaindex.ai/en/latest/api_reference/readers/mongodb/)
        *   [Myscale](https://docs.llamaindex.ai/en/latest/api_reference/readers/myscale/)
        *   [Notion](https://docs.llamaindex.ai/en/latest/api_reference/readers/notion/)
        *   [Nougat ocr](https://docs.llamaindex.ai/en/latest/api_reference/readers/nougat_ocr/)
        *   [Obsidian](https://docs.llamaindex.ai/en/latest/api_reference/readers/obsidian/)
        *   [Openalex](https://docs.llamaindex.ai/en/latest/api_reference/readers/openalex/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/readers/openapi.md)
        *   [Opendal](https://docs.llamaindex.ai/en/latest/api_reference/readers/opendal/)
        *   [Opensearch](https://docs.llamaindex.ai/en/latest/api_reference/readers/opensearch/)
        *   [Oracleai](https://docs.llamaindex.ai/en/latest/api_reference/readers/oracleai/)
        *   [Pandas ai](https://docs.llamaindex.ai/en/latest/api_reference/readers/pandas_ai/)
        *   [Papers](https://docs.llamaindex.ai/en/latest/api_reference/readers/papers/)
        *   [Patentsview](https://docs.llamaindex.ai/en/latest/api_reference/readers/patentsview/)
        *   [Pathway](https://docs.llamaindex.ai/en/latest/api_reference/readers/pathway/)
        *   [Pdb](https://docs.llamaindex.ai/en/latest/api_reference/readers/pdb/)
        *   [Pdf marker](https://docs.llamaindex.ai/en/latest/api_reference/readers/pdf_marker/)
        *   [Pdf table](https://docs.llamaindex.ai/en/latest/api_reference/readers/pdf_table/)
        *   [Pebblo](https://docs.llamaindex.ai/en/latest/api_reference/readers/pebblo/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/readers/pinecone.md)
        *   [Preprocess](https://docs.llamaindex.ai/en/latest/api_reference/readers/preprocess/)
        *   [Psychic](https://docs.llamaindex.ai/en/latest/api_reference/readers/psychic/)
        *   [Qdrant](https://docs.llamaindex.ai/en/latest/api_reference/readers/qdrant/)
        *   [Quip](https://docs.llamaindex.ai/en/latest/api_reference/readers/quip/)
        *   [Rayyan](https://docs.llamaindex.ai/en/latest/api_reference/readers/rayyan/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/readers/readme.md)
        *   [Readwise](https://docs.llamaindex.ai/en/latest/api_reference/readers/readwise/)
        *   [Reddit](https://docs.llamaindex.ai/en/latest/api_reference/readers/reddit/)
        *   [Remote](https://docs.llamaindex.ai/en/latest/api_reference/readers/remote/)
        *   [Remote depth](https://docs.llamaindex.ai/en/latest/api_reference/readers/remote_depth/)
        *   [S3](https://docs.llamaindex.ai/en/latest/api_reference/readers/s3/)
        *   [Sec filings](https://docs.llamaindex.ai/en/latest/api_reference/readers/sec_filings/)
        *   [Semanticscholar](https://docs.llamaindex.ai/en/latest/api_reference/readers/semanticscholar/)
        *   [Simple directory reader](https://docs.llamaindex.ai/en/latest/api_reference/readers/simple_directory_reader/)
        *   [Singlestore](https://docs.llamaindex.ai/en/latest/api_reference/readers/singlestore/)
        *   [Slack](https://docs.llamaindex.ai/en/latest/api_reference/readers/slack/)
        *   [Smart pdf loader](https://docs.llamaindex.ai/en/latest/api_reference/readers/smart_pdf_loader/)
        *   [Snowflake](https://docs.llamaindex.ai/en/latest/api_reference/readers/snowflake/)
        *   [Spotify](https://docs.llamaindex.ai/en/latest/api_reference/readers/spotify/)
        *   [Stackoverflow](https://docs.llamaindex.ai/en/latest/api_reference/readers/stackoverflow/)
        *   [Steamship](https://docs.llamaindex.ai/en/latest/api_reference/readers/steamship/)
        *   [String iterable](https://docs.llamaindex.ai/en/latest/api_reference/readers/string_iterable/)
        *   [Stripe docs](https://docs.llamaindex.ai/en/latest/api_reference/readers/stripe_docs/)
        *   [Structured data](https://docs.llamaindex.ai/en/latest/api_reference/readers/structured_data/)
        *   [Telegram](https://docs.llamaindex.ai/en/latest/api_reference/readers/telegram/)
        *   [Toggl](https://docs.llamaindex.ai/en/latest/api_reference/readers/toggl/)
        *   [Trello](https://docs.llamaindex.ai/en/latest/api_reference/readers/trello/)
        *   [Twitter](https://docs.llamaindex.ai/en/latest/api_reference/readers/twitter/)
        *   [Txtai](https://docs.llamaindex.ai/en/latest/api_reference/readers/txtai/)
        *   [Upstage](https://docs.llamaindex.ai/en/latest/api_reference/readers/upstage/)
        *   [Weather](https://docs.llamaindex.ai/en/latest/api_reference/readers/weather/)
        *   [Weaviate](https://docs.llamaindex.ai/en/latest/api_reference/readers/weaviate/)
        *   [Web](https://docs.llamaindex.ai/en/latest/api_reference/readers/web/)
        *   [Whatsapp](https://docs.llamaindex.ai/en/latest/api_reference/readers/whatsapp/)
        *   [Wikipedia](https://docs.llamaindex.ai/en/latest/api_reference/readers/wikipedia/)
        *   [Wordlift](https://docs.llamaindex.ai/en/latest/api_reference/readers/wordlift/)
        *   [Wordpress](https://docs.llamaindex.ai/en/latest/api_reference/readers/wordpress/)
        *   [Youtube transcript](https://docs.llamaindex.ai/en/latest/api_reference/readers/youtube_transcript/)
        *   [Zendesk](https://docs.llamaindex.ai/en/latest/api_reference/readers/zendesk/)
        *   [Zep](https://docs.llamaindex.ai/en/latest/api_reference/readers/zep/)
        *   [Zulip](https://docs.llamaindex.ai/en/latest/api_reference/readers/zulip/)
        *   [Zyte serp](https://docs.llamaindex.ai/en/latest/api_reference/readers/zyte_serp/)
        
    *   [ ] 
        
        [Response Synthesizers](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/)
        
        Response Synthesizers
        
        *   [Accumulate](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/accumulate/)
        *   [Compact accumulate](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/compact_accumulate/)
        *   [Compact and refine](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/compact_and_refine/)
        *   [Generation](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/generation/)
        *   [Google](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/google/)
        *   [Refine](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/refine/)
        *   [Simple summarize](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/simple_summarize/)
        *   [Tree summarize](https://docs.llamaindex.ai/en/latest/api_reference/response_synthesizers/tree_summarize/)
        
    *   [ ] 
        
        [Retrievers](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/)
        
        Retrievers
        
        *   [Auto merging](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/auto_merging/)
        *   [Bedrock](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/bedrock/)
        *   [Bm25](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/bm25/)
        *   [Duckdb retriever](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/duckdb_retriever/)
        *   [Keyword](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/keyword/)
        *   [Knowledge graph](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/knowledge_graph/)
        *   [Mongodb atlas bm25 retriever](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/mongodb_atlas_bm25_retriever/)
        *   [Pathway](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/pathway/)
        *   [Query fusion](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/query_fusion/)
        *   [Recursive](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/recursive/)
        *   [Router](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/router/)
        *   [Sql](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/sql/)
        *   [Summary](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/summary/)
        *   [Transform](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/transform/)
        *   [Tree](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/tree/)
        *   [Vector](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/vector/)
        *   [Vertexai search](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/vertexai_search/)
        *   [Videodb](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/videodb/)
        *   [You](https://docs.llamaindex.ai/en/latest/api_reference/retrievers/you/)
        
    *   [ ] 
        
        [Schema](https://docs.llamaindex.ai/en/latest/api_reference/schema/)
    ...
    *   [ ]  Selectors
        ...
        *   [Notdiamond](https://docs.llamaindex.ai/en/latest/api_reference/selectors/notdiamond/)
        
    *   [ ]  Sparse Embeddings
        
        Sparse Embeddings
        
        *   [Fastembed](https://docs.llamaindex.ai/en/latest/api_reference/sparse_embeddings/fastembed/)
    ...
    *   [ ]  Storage
        ...
        *   [ ] 
            ...
            [Chat Store](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/)
            
            Chat Store
            
            *   [Azure](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/azure/)
            *   [Azurecosmosmongovcore](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/azurecosmosmongovcore/)
            *   [Azurecosmosnosql](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/azurecosmosnosql/)
            *   [Dynamodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/dynamodb/)
            *   [Postgres](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/postgres/)
            *   [Redis](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/redis/)
            *   [Simple](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/simple/)
            *   [Tablestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/tablestore/)
            *   [Upstash](https://docs.llamaindex.ai/en/latest/api_reference/storage/chat_store/upstash/)
            
        *   [ ] 
            
            [Docstore](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/)
            
            Docstore
            
            *   [Azure](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/azure/)
            *   [Azurecosmosnosql](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/azurecosmosnosql/)
            *   [Couchbase](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/couchbase/)
            *   [Dynamodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/dynamodb/)
            *   [Elasticsearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/elasticsearch/)
            *   [Firestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/firestore/)
            *   [Mongodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/mongodb/)
            *   [Postgres](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/postgres/)
            *   [Redis](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/redis/)
            *   [Simple](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/simple/)
            *   [Tablestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/docstore/tablestore/)
            
        *   [ ] 
            
            [Graph Stores](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/)
            
            Graph Stores
            
            *   [Falkordb](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/falkordb/)
            *   [Kuzu](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/kuzu/)
            *   [Memgraph](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/memgraph/)
            *   [Nebula](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/nebula/)
            *   [Neo4j](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/neo4j/)
            *   [Neptune](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/neptune/)
            *   [Simple](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/simple/)
            *   [Tidb](https://docs.llamaindex.ai/en/latest/api_reference/storage/graph_stores/tidb/)
            
        *   [ ] 
            
            [Index Store](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/)
            
            Index Store
            
            *   [Azure](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/azure/)
            *   [Azurecosmosnosql](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/azurecosmosnosql/)
            *   [Couchbase](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/couchbase/)
            *   [Dynamodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/dynamodb/)
            *   [Elasticsearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/elasticsearch/)
            *   [Firestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/firestore/)
            *   [Mongodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/mongodb/)
            *   [Postgres](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/postgres/)
            *   [Redis](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/redis/)
            *   [Simple](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/simple/)
            *   [Tablestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/index_store/tablestore/)
            
        *   [ ] 
            
            [Kvstore](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/)
            
            Kvstore
            
            *   [Azure](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/azure/)
            *   [Azurecosmosnosql](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/azurecosmosnosql/)
            *   [Couchbase](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/couchbase/)
            *   [Dynamodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/dynamodb/)
            *   [Elasticsearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/elasticsearch/)
            *   [Firestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/firestore/)
            *   [Mongodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/mongodb/)
            *   [Postgres](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/postgres/)
            *   [Redis](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/redis/)
            *   [S3](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/s3/)
            *   [Simple](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/simple/)
            *   [Tablestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/kvstore/tablestore/)
        ...
        *   [ ] 
            ...
            [Vector Store](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/)
            
            Vector Store
            
            *   [Alibabacloud opensearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/alibabacloud_opensearch/)
            *   [Analyticdb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/analyticdb/)
            *   [Astra db](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/astra_db/)
            *   [Awadb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/awadb/)
            *   [Awsdocdb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/awsdocdb/)
            *   [Azureaisearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/azureaisearch/)
            *   [Azurecosmosmongo](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/azurecosmosmongo/)
            *   [Azurecosmosnosql](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/azurecosmosnosql/)
            *   [Bagel](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/bagel/)
            *   [Baiduvectordb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/baiduvectordb/)
            *   [Cassandra](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/cassandra/)
            *   [None](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/chatgpt_plugin.md)
            *   [Chroma](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/chroma/)
            *   [Clickhouse](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/clickhouse/)
            *   [Couchbase](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/couchbase/)
            *   [Dashvector](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/dashvector/)
            *   [Databricks](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/databricks/)
            *   [Deeplake](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/deeplake/)
            *   [Docarray](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/docarray/)
            *   [Duckdb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/duckdb/)
            *   [Dynamodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/dynamodb/)
            *   [Elasticsearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/elasticsearch/)
            *   [Epsilla](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/epsilla/)
            *   [Faiss](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/faiss/)
            *   [Firestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/firestore/)
            *   [Google](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/google/)
            *   [Hologres](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/hologres/)
            *   [Jaguar](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/jaguar/)
            *   [Kdbai](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/kdbai/)
            *   [Lancedb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/lancedb/)
            *   [Lantern](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/lantern/)
            *   [Lindorm](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/lindorm/)
            *   [Mariadb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/mariadb/)
            *   [None](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/metal.md)
            *   [Milvus](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/milvus/)
            *   [Mongodb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/mongodb/)
            *   [Myscale](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/myscale/)
            *   [Neo4jvector](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/neo4jvector/)
            *   [Neptune](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/neptune/)
            *   [Nile](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/nile/)
            *   [Objectbox](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/objectbox/)
            *   [Oceanbase](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/oceanbase/)
            *   [Opensearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/opensearch/)
            *   [Oracledb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/oracledb/)
            *   [Pgvecto rs](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/pgvecto_rs/)
            *   [Pinecone](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/pinecone/)
            *   [Postgres](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/postgres/)
            *   [Qdrant](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/qdrant/)
            *   [Redis](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/redis/)
            *   [Relyt](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/relyt/)
            *   [Rocksetdb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/rocksetdb/)
            *   [Simple](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/simple/)
            *   [Singlestoredb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/singlestoredb/)
            *   [None](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/sqlalchemy.md)
            *   [Supabase](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/supabase/)
            *   [Tablestore](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/tablestore/)
            *   [Tair](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/tair/)
            *   [Tencentvectordb](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/tencentvectordb/)
            *   [Tidbvector](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/tidbvector/)
            *   [Timescalevector](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/timescalevector/)
            *   [Txtai](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/txtai/)
            *   [Typesense](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/typesense/)
            *   [Upstash](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/upstash/)
            *   [Vearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/vearch/)
            *   [Vertexaivectorsearch](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/vertexaivectorsearch/)
            *   [Vespa](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/vespa/)
            *   [Weaviate](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/weaviate/)
            *   [Wordlift](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/wordlift/)
            *   [Zep](https://docs.llamaindex.ai/en/latest/api_reference/storage/vector_store/zep/)
            
        
    *   [ ] 
        
        [Tools](https://docs.llamaindex.ai/en/latest/api_reference/tools/)
        
        Tools
        
        *   [Arxiv](https://docs.llamaindex.ai/en/latest/api_reference/tools/arxiv/)
        *   [Azure code interpreter](https://docs.llamaindex.ai/en/latest/api_reference/tools/azure_code_interpreter/)
        *   [Azure cv](https://docs.llamaindex.ai/en/latest/api_reference/tools/azure_cv/)
        *   [Azure speech](https://docs.llamaindex.ai/en/latest/api_reference/tools/azure_speech/)
        *   [Azure translate](https://docs.llamaindex.ai/en/latest/api_reference/tools/azure_translate/)
        *   [Bing search](https://docs.llamaindex.ai/en/latest/api_reference/tools/bing_search/)
        *   [Box](https://docs.llamaindex.ai/en/latest/api_reference/tools/box/)
        *   [Brave search](https://docs.llamaindex.ai/en/latest/api_reference/tools/brave_search/)
        *   [Cassandra](https://docs.llamaindex.ai/en/latest/api_reference/tools/cassandra/)
        *   [Chatgpt plugin](https://docs.llamaindex.ai/en/latest/api_reference/tools/chatgpt_plugin/)
        *   [Code interpreter](https://docs.llamaindex.ai/en/latest/api_reference/tools/code_interpreter/)
        *   [Cogniswitch](https://docs.llamaindex.ai/en/latest/api_reference/tools/cogniswitch/)
        *   [Database](https://docs.llamaindex.ai/en/latest/api_reference/tools/database/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/tools/docker_code.md)
        *   [Duckduckgo](https://docs.llamaindex.ai/en/latest/api_reference/tools/duckduckgo/)
        *   [Elevenlabs](https://docs.llamaindex.ai/en/latest/api_reference/tools/elevenlabs/)
        *   [Exa](https://docs.llamaindex.ai/en/latest/api_reference/tools/exa/)
        *   [Finance](https://docs.llamaindex.ai/en/latest/api_reference/tools/finance/)
        *   [Function](https://docs.llamaindex.ai/en/latest/api_reference/tools/function/)
        *   [Google](https://docs.llamaindex.ai/en/latest/api_reference/tools/google/)
        *   [Graphql](https://docs.llamaindex.ai/en/latest/api_reference/tools/graphql/)
        *   [Ionic shopping](https://docs.llamaindex.ai/en/latest/api_reference/tools/ionic_shopping/)
        *   [Jina](https://docs.llamaindex.ai/en/latest/api_reference/tools/jina/)
        *   [Load and search](https://docs.llamaindex.ai/en/latest/api_reference/tools/load_and_search/)
        *   [Metaphor](https://docs.llamaindex.ai/en/latest/api_reference/tools/metaphor/)
        *   [Multion](https://docs.llamaindex.ai/en/latest/api_reference/tools/multion/)
        *   [Neo4j](https://docs.llamaindex.ai/en/latest/api_reference/tools/neo4j/)
        *   [Notion](https://docs.llamaindex.ai/en/latest/api_reference/tools/notion/)
        *   [Ondemand loader](https://docs.llamaindex.ai/en/latest/api_reference/tools/ondemand_loader/)
        *   [Openai](https://docs.llamaindex.ai/en/latest/api_reference/tools/openai/)
        *   [Openapi](https://docs.llamaindex.ai/en/latest/api_reference/tools/openapi/)
        *   [None](https://docs.llamaindex.ai/en/latest/api_reference/tools/oracleai.md)
        *   [Playgrounds](https://docs.llamaindex.ai/en/latest/api_reference/tools/playgrounds/)
        *   [Python file](https://docs.llamaindex.ai/en/latest/api_reference/tools/python_file/)
        *   [Query engine](https://docs.llamaindex.ai/en/latest/api_reference/tools/query_engine/)
        *   [Query plan](https://docs.llamaindex.ai/en/latest/api_reference/tools/query_plan/)
        *   [Requests](https://docs.llamaindex.ai/en/latest/api_reference/tools/requests/)
        *   [Retriever](https://docs.llamaindex.ai/en/latest/api_reference/tools/retriever/)
        *   [Salesforce](https://docs.llamaindex.ai/en/latest/api_reference/tools/salesforce/)
        *   [Scrapegraph](https://docs.llamaindex.ai/en/latest/api_reference/tools/scrapegraph/)
        *   [Shopify](https://docs.llamaindex.ai/en/latest/api_reference/tools/shopify/)
        *   [Slack](https://docs.llamaindex.ai/en/latest/api_reference/tools/slack/)
        *   [Tavily research](https://docs.llamaindex.ai/en/latest/api_reference/tools/tavily_research/)
        *   [Text to image](https://docs.llamaindex.ai/en/latest/api_reference/tools/text_to_image/)
        *   [Tool spec](https://docs.llamaindex.ai/en/latest/api_reference/tools/tool_spec/)
        *   [Vectara query](https://docs.llamaindex.ai/en/latest/api_reference/tools/vectara_query/)
        *   [Vector db](https://docs.llamaindex.ai/en/latest/api_reference/tools/vector_db/)
        *   [Waii](https://docs.llamaindex.ai/en/latest/api_reference/tools/waii/)
        *   [Weather](https://docs.llamaindex.ai/en/latest/api_reference/tools/weather/)
        *   [Wikipedia](https://docs.llamaindex.ai/en/latest/api_reference/tools/wikipedia/)
        *   [Wolfram alpha](https://docs.llamaindex.ai/en/latest/api_reference/tools/wolfram_alpha/)
        *   [Yahoo finance](https://docs.llamaindex.ai/en/latest/api_reference/tools/yahoo_finance/)
        *   [Yelp](https://docs.llamaindex.ai/en/latest/api_reference/tools/yelp/)
        *   [Zapier](https://docs.llamaindex.ai/en/latest/api_reference/tools/zapier/)
        
    *   [ ]  Workflow
        
        Workflow
        
        *   [Decorators](https://docs.llamaindex.ai/en/latest/api_reference/workflow/decorators/)
        *   [Context](https://docs.llamaindex.ai/en/latest/api_reference/workflow/context/)
        *   [Events](https://docs.llamaindex.ai/en/latest/api_reference/workflow/events/)
        *   [Retry policy](https://docs.llamaindex.ai/en/latest/api_reference/workflow/retry_policy/)
        *   [Workflow](https://docs.llamaindex.ai/en/latest/api_reference/workflow/workflow/)
        
    
*   [ ] 
    
    [Open-Source Community](https://docs.llamaindex.ai/en/latest/community/llama_packs/)
    
    Open-Source Community
    
    *   [Integrations](https://docs.llamaindex.ai/en/latest/community/integrations/)
    *   [Full Stack Projects](https://docs.llamaindex.ai/en/latest/community/full_stack_projects/)
    *   [ ]  Community FAQ
        
        Community FAQ
        
        *   [Chat Engines](https://docs.llamaindex.ai/en/latest/community/faq/chat_engines/)
        *   [Documents and Nodes](https://docs.llamaindex.ai/en/latest/community/faq/documents_and_nodes/)
        *   [Embeddings](https://docs.llamaindex.ai/en/latest/community/faq/embeddings/)
        *   [Large Language Models](https://docs.llamaindex.ai/en/latest/community/faq/llms/)
        *   [Query Engines](https://docs.llamaindex.ai/en/latest/community/faq/query_engines/)
        *   [Vector Database](https://docs.llamaindex.ai/en/latest/community/faq/vector_database/)
        
    *   [ ]  Contributing
        
        Contributing
        
        *   [Code](https://docs.llamaindex.ai/en/latest/CONTRIBUTING/)
        *   [Docs](https://docs.llamaindex.ai/en/latest/DOCS_README/)
        
    *   [Changelog](https://docs.llamaindex.ai/en/latest/CHANGELOG/)
    *   [Presentations](https://docs.llamaindex.ai/en/latest/presentations/past_presentations/)
    *   [Deprecated Terms](https://docs.llamaindex.ai/en/latest/changes/deprecated_terms/)
...
*   [ ] 
    ...
    *   [LlamaParse](https://docs.llamaindex.ai/en/latest/llama_cloud/llama_parse/)
    

Table of contents

*   [Introduction](https://docs.llamaindex.ai/en/latest/index.html#introduction)
    
    *   [What are agents?](https://docs.llamaindex.ai/en/latest/index.html#what-are-agents)
    *   [What are workflows?](https://docs.llamaindex.ai/en/latest/index.html#what-are-workflows)
    *   [What is context augmentation?](https://docs.llamaindex.ai/en/latest/index.html#what-is-context-augmentation)
    *   [LlamaIndex is the framework for Context-Augmented LLM Applications](https://docs.llamaindex.ai/en/latest/index.html#llamaindex-is-the-framework-for-context-augmented-llm-applications)
    
*   [Use cases](https://docs.llamaindex.ai/en/latest/index.html#use-cases)
    
    *   [👨‍👩‍👧‍👦 Who is LlamaIndex for?](https://docs.llamaindex.ai/en/latest/index.html#who-is-llamaindex-for)
    
*   [Getting Started](https://docs.llamaindex.ai/en/latest/index.html#getting-started)
    
    *   [30 second quickstart](https://docs.llamaindex.ai/en/latest/index.html#30-second-quickstart)
    
*   [LlamaCloud](https://docs.llamaindex.ai/en/latest/index.html#llamacloud)
    
    *   [LlamaParse](https://docs.llamaindex.ai/en/latest/index.html#llamaparse)
    
*   [Community](https://docs.llamaindex.ai/en/latest/index.html#community)
    
    *   [Getting the library](https://docs.llamaindex.ai/en/latest/index.html#getting-the-library)
    *   [Contributing](https://docs.llamaindex.ai/en/latest/index.html#contributing)
    
*   [LlamaIndex Ecosystem](https://docs.llamaindex.ai/en/latest/index.html#llamaindex-ecosystem)

Welcome to LlamaIndex 🦙 ![#](https://docs.llamaindex.ai/en/latest/index.html#welcome-to-llamaindex "Permanent link")
=====================================================================================================================

LlamaIndex is the leading framework for building LLM-powered agents over your data with [LLMs](https://en.wikipedia.org/wiki/Large_language_model) and [workflows](https://docs.llamaindex.ai/en/latest/understanding/workflows/).
...
*   [Related projects](https://docs.llamaindex.ai/en/latest/index.html#related-projects)
...
Introduction[#](https://docs.llamaindex.ai/en/latest/index.html#introduction "Permanent link")
----------------------------------------------------------------------------------------------

### What are agents?[#](https://docs.llamaindex.ai/en/latest/index.html#what-are-agents "Permanent link")

[Agents](https://docs.llamaindex.ai/en/latest/understanding/agent/basic_agent/) are LLM-powered knowledge assistants that use tools to perform tasks like research, data extraction, and more. Agents range from simple question-answering to being able to sense, decide and take actions in order to complete tasks.
...
### What are workflows?[#](https://docs.llamaindex.ai/en/latest/index.html#what-are-workflows "Permanent link")

[Workflows](https://docs.llamaindex.ai/en/latest/understanding/workflows/) are multi-step processes that combine one or more agents, data connectors, and other tools to complete a task. They are event-driven software that allows you to combine RAG data sources and multiple agents to create a complex application that can perform a wide variety of tasks with reflection, error-correction, and other hallmarks of advanced LLM applications. You can then [deploy these agentic workflows](https://docs.llamaindex.ai/en/latest/module_guides/workflow/deployment.md) as production microservices.

### What is context augmentation?[#](https://docs.llamaindex.ai/en/latest/index.html#what-is-context-augmentation "Permanent link")
...
The most popular example of context-augmentation is [Retrieval-Augmented Generation or RAG](https://docs.llamaindex.ai/en/latest/getting_started/concepts/), which combines context with LLMs at inference time.

### LlamaIndex is the framework for Context-Augmented LLM Applications[#](https://docs.llamaindex.ai/en/latest/index.html#llamaindex-is-the-framework-for-context-augmented-llm-applications "Permanent link")
...
Use cases[#](https://docs.llamaindex.ai/en/latest/index.html#use-cases "Permanent link")
----------------------------------------------------------------------------------------

Some popular use cases for LlamaIndex and context augmentation in general include:

*   [Question-Answering](https://docs.llamaindex.ai/en/latest/use_cases/q_and_a/) (Retrieval-Augmented Generation aka RAG)
*   [Chatbots](https://docs.llamaindex.ai/en/latest/use_cases/chatbots/)
*   [Document Understanding and Data Extraction](https://docs.llamaindex.ai/en/latest/use_cases/extraction/)
*   [Autonomous Agents](https://docs.llamaindex.ai/en/latest/use_cases/agents/) that can perform research and take actions
*   [Multi-modal applications](https://docs.llamaindex.ai/en/latest/use_cases/multimodal/) that combine text, images, and other data types
*   [Fine-tuning](https://docs.llamaindex.ai/en/latest/use_cases/fine_tuning/) models on data to improve performance

Check out our [use cases](https://docs.llamaindex.ai/en/latest/use_cases/) documentation for more examples and links to tutorials.

### 👨‍👩‍👧‍👦 Who is LlamaIndex for?[#](https://docs.llamaindex.ai/en/latest/index.html#who-is-llamaindex-for "Permanent link")
...
Getting Started[#](https://docs.llamaindex.ai/en/latest/index.html#getting-started "Permanent link")
----------------------------------------------------------------------------------------------------

LlamaIndex is available in Python (these docs) and [Typescript](https://ts.llamaindex.ai/). If you're not sure where to start, we recommend reading [how to read these docs](https://docs.llamaindex.ai/en/latest/getting_started/reading/) which will point you to the right place based on your experience level.

### 30 second quickstart[#](https://docs.llamaindex.ai/en/latest/index.html#30-second-quickstart "Permanent link")
...
If any part of this trips you up, don't worry! Check out our more comprehensive starter tutorials using [remote APIs like OpenAI](https://docs.llamaindex.ai/en/latest/getting_started/starter_example/) or [any model that runs on your laptop](https://docs.llamaindex.ai/en/latest/getting_started/starter_example_local/).

LlamaCloud[#](https://docs.llamaindex.ai/en/latest/index.html#llamacloud "Permanent link")
------------------------------------------------------------------------------------------
...
### LlamaParse[#](https://docs.llamaindex.ai/en/latest/index.html#llamaparse "Permanent link")
...
Community[#](https://docs.llamaindex.ai/en/latest/index.html#community "Permanent link")
----------------------------------------------------------------------------------------
...
### Getting the library[#](https://docs.llamaindex.ai/en/latest/index.html#getting-the-library "Permanent link")
...
### Contributing[#](https://docs.llamaindex.ai/en/latest/index.html#contributing "Permanent link")

We are open-source and always welcome contributions to the project! Check out our [contributing guide](https://docs.llamaindex.ai/en/latest/CONTRIBUTING/) for full details on how to extend the core library or add an integration to a third party like an LLM, a vector store, an agent tool and more.

LlamaIndex Ecosystem[#](https://docs.llamaindex.ai/en/latest/index.html#llamaindex-ecosystem "Permanent link")
--------------------------------------------------------------------------------------------------------------
...
[Next High-Level Concepts](https://docs.llamaindex.ai/en/latest/getting_started/concepts/)
